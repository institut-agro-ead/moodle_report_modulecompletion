...
function xmldb_report_modulecompletion_upgrade($oldversion) {
    ...
    if ($oldversion < 2018032800) {
        // Define field order_by_column to be added to report_mc_filter.
        $table = new xmldb_table('report_mc_filter');
    ...
    if ($oldversion < 2018120500) {
        // Define field cohorts to be added to report_mc_filter.
        $table = new xmldb_table('report_mc_filter');
    ...
    if ($oldversion < 2020120800) {
        // Define field only_cohorts_courses to be added to report_mc_filter.
        $table = new xmldb_table('report_mc_filter');
